...
SET
    ...
    exec_company_id = COALESCE($29, exec_company_id),
    updated_at = NOW()
WHERE (id = $1 AND company_id = $30) AND (active = 1 AND deleted = 0)
RETURNING id;
`
