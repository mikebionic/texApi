...
import (
	"log"
	"texApi/config"
	repositories2 "texApi/internal/_other/repositories"
...
func AdminLogin(ctx *gin.Context) {
	...
	findedAdmin := repositories2.GetAdmin(admin.Phone)
...
func UserLogin(ctx *gin.Context) {
	...
	findedUser := repositories2.GetUserForLogin(user.Phone)
	...
	err := repositories2.SetUserNotificationToken(user.NotificationToken, findedUser.ID)
...
func UserGetMe(ctx *gin.Context) {
	...
	user := repositories2.GetUserMe(userID)
...
func WorkerLogin(ctx *gin.Context) {
	...
	findedWorker := repositories2.GetWorkerForLogin(worker.Phone)
...
func RefreshNotificationToken(ctx *gin.Context) {
	...
	repositories2.SetUserNotificationToken(notificationToken.Token, id)
