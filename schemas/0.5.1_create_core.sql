...
CREATE TYPE state_t AS ENUM ('enabled', 'disabled', 'deleted', 'pending', 'archived');
...
INSERT INTO tbl_packaging_types (name_ru, name_en, category_ru, category_en, material, dimensions, weight, description_ru, description_en)
VALUES
