...
INSERT INTO tbl_user (username, password, email, first_name, last_name, nick_name, avatar_url, phone, address, role_id, verified, active, deleted)
VALUES
    ('root', 'PASSWORD_PLACEHOLDER', 'texlogistics@gmail.com', 'Tex', 'Admin', 'Texy', '', '+0036123456', 'Ashgabat, Turkmenistan', 1, 1, 1, 0),
    ('customer1', 'PASSWORD_PLACEHOLDER', 'customer1@example.com', 'Customer', 'One', 'Custy', '', '+123456789', 'Ashgabat, Turkmenistan', 2, 1, 1, 0),
    ('driver1', 'PASSWORD_PLACEHOLDER', 'driver1@example.com', 'Volodya', '', 'Driver', '', '+123456789', 'Ashgabat, Turkmenistan', 3, 1, 1, 0);
