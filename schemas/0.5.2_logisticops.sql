...
(
    ...
    driver_id      INT            REFERENCES tbl_driver (id) ON DELETE CASCADE  DEFAULT 0,
    vehicle_id   INT            REFERENCES tbl_vehicle (id) ON DELETE CASCADE DEFAULT 0,
...
(
    ...
    uuid       UUID                                                         DEFAULT gen_random_uuid(),
    company_id     INT            REFERENCES tbl_company (id) ON DELETE CASCADE DEFAULT 0,
    bid_user_id    INT              REFERENCES tbl_user (id) ON DELETE CASCADE DEFAULT 0,
